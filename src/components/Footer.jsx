        ...
        <footer id="visit-us" className="bg-bg-primary pt-24 pb-8 border-t-4 border-gold">
            <div className="container mx-auto px-6 max-w-6xl">
                ...
                <div className="text-center mb-16">
                    <h2 className="font-display text-4xl md:text-5xl uppercase tracking-widest text-white mb-2">
                ...
                <div className="border-t border-border pt-8 flex flex-col items-center">
                    ...
                    <div className="flex gap-6 mb-8">
                        <a href="#" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-text-secondary hover:text-gold hover:border-gold transition-colors" aria-label="Facebook">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" /></svg>
                        </a>
                        <a href="#" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-text-secondary hover:text-gold hover:border-gold transition-colors" aria-label="Instagram">
                        ...
                        <a href="#" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-text-secondary hover:text-gold hover:border-gold transition-colors" aria-label="Twitter">
                    ...
                    <div className="flex gap-4 md:gap-8 mb-4">
                        <a href="#home" className="text-xs font-body tracking-wider text-text-secondary hover:text-gold transition-colors">Home</a>
                        <a href="#about" className="text-xs font-body tracking-wider text-text-secondary hover:text-gold transition-colors">About</a>
                        <a href="#menu" className="text-xs font-body tracking-wider text-text-secondary hover:text-gold transition-colors">Menu</a>
                        <a href="#gallery" className="text-xs font-body tracking-wider text-text-secondary hover:text-gold transition-colors">Gallery</a>
                        <a href="#franchise" className="text-xs font-body tracking-wider text-text-secondary hover:text-gold transition-colors">Franchise</a>
                        <a href="#contact" className="text-xs font-body tracking-wider text-text-secondary hover:text-gold transition-colors">Contact</a>
                    </div>
